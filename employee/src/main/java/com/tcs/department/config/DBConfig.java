package com.tcs.department.config;
...
@EnableJpaRepositories("com.tcs.department.repository")
@PropertySource("classpath:db.properties")
@ComponentScan("com.tcs.department")
...
public class DBConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("com.tcs.department.model");
